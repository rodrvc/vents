...
public class VentaController implements Initializable {
    ...
    public Venta instanciaDeVenta() {
        ...
        Venta instanciaVenta = new Venta(Venta.obtenerUltimaVenta(con.getConexion()), usuario.getIdUsuario(), cliente, cantidad, " ");
    ...
    public void realizarVenta() {
        con = new Conexion();
        Venta.insertarVenta(con.getConexion(), venta, usuario.getIdUsuario(), cliente);
        venta = instanciaDeVenta();
        con.cerrarConexion();
        con = new Conexion();
